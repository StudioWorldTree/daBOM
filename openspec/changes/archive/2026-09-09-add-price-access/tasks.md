...
- [x] Reword roll-up rule in design + delta: within a vendor rank method then newest; across vendors preferred vendor, else method rank, then newest (scenario "API beats a later crawl" is the truth)
